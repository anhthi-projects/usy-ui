...
const SvgObjectsColumnFilled = ({
  ...
  <svg
    ...
    fill="currentColor"
    aria-hidden="true"
    className="objects-column-filled_svg__w-6 objects-column-filled_svg__h-6 objects-column-filled_svg__text-gray-800 objects-column-filled_svg__dark:text-white"
    viewBox="0 0 24 24"
...
export default SvgObjectsColumnFilled;
