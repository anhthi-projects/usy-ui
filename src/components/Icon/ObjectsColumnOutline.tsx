...
const SvgObjectsColumnOutline = ({
  ...
  <svg
    ...
    fill="none"
    aria-hidden="true"
    className="objects-column-outline_svg__w-6 objects-column-outline_svg__h-6 objects-column-outline_svg__text-gray-800 objects-column-outline_svg__dark:text-white"
    viewBox="0 0 24 24"
...
export default SvgObjectsColumnOutline;
