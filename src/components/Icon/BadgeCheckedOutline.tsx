...
const SvgBadgeCheckedOutline = ({
  ...
  <svg
    ...
    fill="none"
    aria-hidden="true"
    className="badge-checked-outline_svg__w-6 badge-checked-outline_svg__h-6 badge-checked-outline_svg__text-gray-800 badge-checked-outline_svg__dark:text-white"
    viewBox="0 0 24 24"
...
export default SvgBadgeCheckedOutline;
